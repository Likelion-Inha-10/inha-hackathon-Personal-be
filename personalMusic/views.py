...
# red 0 green 0 blue 1 => 2(피아노)
# red 0 green 1 blue 0 => 3(파이프 오르간)
# red 0 green 1 blue 1 => 4(첼로)
# red 1 green 0 blue 0 => 5(마림바)
# red 1 green 0 blue 1 => 6(바이올린)
# red 1 green 1 blue 0 => 7(팀파니)
# red 1 green 1 blue 1 => 8(오보에)